      ...
      <div className="agency-services-area pt-80 pb-50">
        <div className="container">
          <div className="section-title st-fs-28">
            <span className="sub-title">T-Rex Platform</span>
            <h2>Business Model & Growth</h2>
            <div className="bar"></div>
            <p>
              Tiered subscription model: Standard, AI, Ultra AI. Marketplace for tools and assets. Strategic focus on value, retention, and sustainable growth.
            </p>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-sm-6 col-md-6">
              <div className="agency-services-box">
                ...
                <div className="content">
                  <h3>
                    <Link to="/service-details">Standard: $15/month</Link>
                  </h3>
            ...
            <div className="col-lg-4 col-sm-6 col-md-6">
              <div className="agency-services-box">
                ...
                <div className="content">
                  <h3>
                    <Link to="/service-details">AI: $35/month</Link>
                  </h3>
            ...
            <div className="col-lg-4 col-sm-6 col-md-6">
              <div className="agency-services-box">
                ...
                <div className="content">
                  <h3>
                    <Link to="/service-details">Ultra AI: $75/month</Link>
                  </h3>

            ...
            <div className="col-lg-6 col-md-12">
              <div className="ml-banner-content">
                <h1
                  ...
                  data-aos-once="false"
                >
                  T-Rex Platform: Empowering the Creator Economy
                </h1>
                <p
                  data-aos="fade-up"
                  data-aos-delay="200"
                  ...
                  data-aos-once="false"
                >
                  The all-in-one AI-driven platform for creators. Modular, multi-platform, and built for growth. Unlock actionable guidance, smart scheduling, and revenue optimization. Join the next wave of the creator economy.
                </p>
